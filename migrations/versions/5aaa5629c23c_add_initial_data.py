...
Revision ID: 63d7c63fec92
Revises: 
Create Date: 2025-01-14 18:50:59.040100
...
def upgrade():
    ...
    op.create_table('pets',
        ...
        sa.CheckConstraint("sex IN ('Male', 'Female')", name='check_sex'),
    ...
    for breed in dog_breeds:
        if not Breed.query.filter_by(name=breed).first():
            db.session.add(Breed(species_id=2, name=breed))  # species_id=2 para Dog
    ...
    for breed in cat_breeds:
        if not Breed.query.filter_by(name=breed).first():
            db.session.add(Breed(species_id=1, name=breed))  # species_id=1 para Cat
